...
$page_title = $email.' payments details';
...
<th> date </th>
								...
								<?php
									...
									$sql = "SELECT * FROM $table WHERE email='$email' ORDER BY id DESC LIMIT $offset, $rowsperpage ";
									$result = mysqli_query($conn, $sql) or trigger_error("SQL", E_USER_ERROR);
...
<td> <?php echo$row['payment_id']; if($row['payment_id'] == ''){ echo 'not avilabel'; } ?> </td>
